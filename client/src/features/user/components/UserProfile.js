...
import { selectUserInfo, updateUserAsync, deleteUserAsync } from '../userSlice';
        ...
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          <div className="flex justify-between items-start">
            <div>
              ...
              <Modal
                title={`Delete ${userInfo.name ? userInfo.name.toUpperCase() : 'User'}`}
                message="Are you sure you want to delete this account ?"
                dangerOption="Delete"
                cancelOption="Cancel"
                dangerAction={() => handleDelete(userInfo.id)}
            ...
            <div className="flex-shrink-0">
              {userInfo.profilePicture ? (
                <img
                  ...
                  src={`${BACKEND_BASE_URL}/uploads/${userInfo.profilePicture}`}
                  alt={userInfo.name}
