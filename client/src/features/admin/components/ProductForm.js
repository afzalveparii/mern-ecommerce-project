...
function ProductForm() {
  ...
  const handleDelete = () => {
    ...
    alert.error("Product Deleted Suceesfully", { position: 'top center' })
      ...
      <form
        ...
        onSubmit={handleSubmit((data) => {
          ...
          if (params.id) {
            ...
            alert.success('Product Updated', { position: 'top center' });
            setTimeout(() => window.location.href = '/admin', 2000);

            reset();
          } else {
            dispatch(createProductAsync(product));
            alert.success('Product Created', { position: 'top center' });
            setTimeout(() => window.location.href = '/admin', 2000);
            reset();
          }
        })}
                ...
                <div className="mt-2">
                  <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 ">
                    <input
                      ...
                      max: {
                          value: 200000,
                          message: 'Price must not exceed 20000',
                      },
                      })}
                      id="price"
                      className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                ...
                <div className="mt-2">
                  <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 ">
                    <input
                      ...
                      max: {
                          value: 80,
                          message: 'Discount must not exceed 80',
                      },
                      })}
